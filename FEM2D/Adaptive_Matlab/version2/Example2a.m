...
%
%   Cubic finite elements are used.
...
T=RectangleMeshTopLeftD1(4);
T=GenLagrangeMesh2(T,3);
...
err=EnergyNormErr2(T,k,ux,uy,U,g);
nrm=EnergyNorm2(T,k,ux,uy);
