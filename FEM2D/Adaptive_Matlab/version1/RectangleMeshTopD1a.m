function T=RectangleMeshTopD1a(nx,ny,lx,ly)

% T=RectangleMeshTopD1a(nx,ny,lx,ly)
%
...
%   on the top edge and Neumann conditions elsewhere.  The mesh
%   differs from that produced by RectangleMeshTopD1 in that the
...
T=MakeMesh1(nodes,tris,ny*(nx+1)+1:p);
