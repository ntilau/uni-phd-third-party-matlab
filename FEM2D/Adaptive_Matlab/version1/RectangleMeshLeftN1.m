function T=RectangleMeshLeftN1(nx,ny,lx,ly)

% T=RectangleMeshLeftN1(nx,ny,lx,ly)
%
...
%   ny=nx, lx=1, ly=lx.  Thus, the command "T=RectangleMeshLeftN1(m)"
...
for j=0:ny
   ...
   for i=0:nx
      ...
      % Interior nodes and nodes on the left edge
      % are free:
