function T=RectangleMeshTopLeftD1a(nx,ny,lx,ly)

% T=RectangleMeshTopLeftD1a(nx,ny,lx,ly)
%
...
%   remainder of the boundary.  The mesh differs from that produced
%   by RectangleMeshTopLeftD1 in that the pattern of triangles is
%   symmetric.
%
%   The last three arguments can be omitted; their default values are
%   ny=nx, lx=1, ly=lx.  Thus, the command "T=RectangleMeshTopLeftD1a(m)"
...
T=MakeMesh1(nodes,tris,[1:nx+1:(ny-1)*(nx+1)+1,ny*(nx+1)+1:p]);
