...
%   a Neumann problem on the rectangle [0,lx]x[0,ly].  The mesh
%   differs from that produced by RectangleMeshN1 in that the
%   pattern of triangles is symmetric.
%
%   The last three arguments can be omitted; their default values are
%   ny=nx, lx=1, ly=lx.  Thus, the command "T=RectangleMeshN1a(m)"
