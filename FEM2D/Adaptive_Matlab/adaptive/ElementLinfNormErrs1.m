function m=ElementLinfNormErrs1(T,fnu,U,g)

% m=ElementLinfNormErrs1(T,fnu,U,g)
%
%   This function estimates the L-infinity norm of
%   the difference between the smooth function
%   u(x,y) and the piecewise linear function
%   defined by the mesh T and the nodal values U.
%   The function fnu implements u(x,y).
%
%   The optional input g is a vector containing the
%   nodal values of the piecewise linear function
%   at the constrained nodes.  If g is not given,
